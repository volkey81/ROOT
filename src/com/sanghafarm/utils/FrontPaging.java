 ...
 * 페이징 삽입을 위한 클래스
 */
public class FrontPaging extends Paging {  
	public FrontPaging(String url, int totalRows, int currentPage,	int pageSize, int blockSize) {
	...
	public void writeTo(JspWriter out) throws Exception {
        ...
        if(needPrevBlockAction) {
			buf.append("<li><a href=\"" + pageURL(nStartPage - nBlockSize) + "\"><img src=\"/images/btn/btn_pgPrev2.gif\" alt=\"이전 10페이지\"></a></li>\n");
        }
        else {
			buf.append("<li><a href=\"#none\"><img src=\"/images/btn/btn_pgPrev2.gif\" alt=\"이전 10페이지\"></a></li>\n");
        }
        
        if(needPrevPageAction) {
        	buf.append("<li class=\"btnL\"><a href=\"" + pageURL(nCurrentPage - 1) + "\"><img src=\"/images/btn/btn_pgPrev.gif\" alt=\"이전 페이지\"></a></li>\n");
        }
        else {
        	buf.append("<li class=\"btnL\"><a href=\"#none\"><img src=\"/images/btn/btn_pgPrev.gif\" alt=\"이전 페이지\"></a></li>\n");
        }
        ...
        if(needNextPageAction) {
        	buf.append("<li class=\"btnR\"><a href=\"" + pageURL(nCurrentPage + 1) + "\"><img src=\"/images/btn/btn_pgNext.gif\" alt=\"다음 페이지\"></a></li>\n");
        }
        else {
        	buf.append("<li class=\"btnR\"><a href=\"#none\"><img src=\"/images/btn/btn_pgNext.gif\" alt=\"다음 페이지\"></a></li>\n");
        }

        if(needNextBlockAction) {
        	buf.append("<li><a href=\"" + pageURL(nStartPage + nBlockSize) + "\"><img src=\"/images/btn/btn_pgNext2.gif\" alt=\"다음 10페이지\"></a></li>\n");
        }
        else {
        	buf.append("<li><a href=\"#none\"><img src=\"/images/btn/btn_pgNext2.gif\" alt=\"다음 10페이지\"></a></li>\n");
        }
        out.println(buf);
	}
