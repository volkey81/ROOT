...
public class RXDisagreeUser extends HttpServlet {
...
//		String jsonStr = SystemChecker.getCurrent() == SystemChecker.LOCAL ? getSampleJson() : URLDecoder.decode(param.get("params").trim(), "utf-8");
		...
		JSONObject result = svc.remove(this.getClass().getSimpleName(), json);
		
		out.println(result.toJSONString());
	}

	private String getSampleJson() {
		String s = "{\"TRS_NO\":\"70002016100717290200394\",\"SST_CD\":\"7040\",\"OPN_MD\":\"test\",\"IM_SBC\":{\"UNFY_MMB_NO\":\"1000000001\",\"COOPCO_CD\":\"7000\",\"AGRM_END_DTM\":\"20150725052233\"}}";                                                                                                                  
