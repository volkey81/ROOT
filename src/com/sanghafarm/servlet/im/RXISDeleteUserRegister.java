...
public class RXISDeleteUserRegister extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		logger.info("============= RXISDeleteUserRegister");
...
//		String jsonStr = SystemChecker.getCurrent() == SystemChecker.LOCAL ? getSampleJson() : URLDecoder.decode(param.get("params").trim(), "utf-8");
	...
	private String getSampleJson() {
		String s = "{\"TRS_NO\":\"70002016100717053717062\",\"SST_CD\":\"7040\",\"OPN_MD\":\"test\",\"IM_SBC\":{\"UNFY_MMB_NO\":\"1000000001\"}}";                                                                                                                  
