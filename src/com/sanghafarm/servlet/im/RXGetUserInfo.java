...
public class RXGetUserInfo extends HttpServlet {
...
//		String jsonStr = SystemChecker.getCurrent() == SystemChecker.LOCAL ? getSampleJson() : URLDecoder.decode(param.get("params").trim(), "utf-8");
		...
		JSONObject result = svc.getInfo(this.getClass().getSimpleName(), json);
		
		out.println(result.toJSONString());
	}

	private String getSampleJson() {
		String s = "{\"TRS_NO\":\"100020121031133025000001\",\"OPN_MD\":\"test\",\"SST_CD\":\"7040\",\"IM_SBC\":{\"UNFY_MMB_NO\":\"1000000001\"}}";                                                                                                                  
