...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="contArea">
			...
			<!-- 내용영역 -->	
			<p class="caution">문의하신 내용에 대한 답변은 <a href="/mypage/board/hotelCounsel.jsp" class="fontTypeA">마이페이지 &gt; 파머스빌리지 상담내역</a>에서 확인하실 수 있습니다.</p>
			<p class="caution">비회원 문의는 SMS로 답변 드립니다.</p>
			<form class="" name="hotelCounselForm" id="hotelCounselForm" method="post" action="hotelCounselProc.jsp" enctype="multipart/form-data">
				<input type="hidden" name="mode" id="mode" value="CREATE" />
				<table class="bbsForm typeB">
					<caption>1:1 상담 입력폼</caption>
					<colgroup>
						<col width="130"><col width=""><col width="80"><col width="280">
					</colgroup>
					<tr>
...
<%
	if(fs.isLogin()) {//회원일때
%>
							<input type="checkbox" name="infoCopy" onclick="setUser(this.checked)"><span>고객 정보 동일</span>
<%
	}
%>
						</td>
...
%>
					<tr>
						...
						<td colspan="3"><input type="password" name="passwd" id="passwd"><span>* 비회원 SMS 답변 확인 시 해당 비밀번호로 확인 가능합니다.</span></td>
					</tr>
<% 
	} 
%>
					...
					<tr class="cate 002">
						...
						<td colspan="3" class="availableDates">
							<div class="calInput">
					...
					<tr class="cate 003">
						<th scope="row"><label for="type">일자 및 시간</label></th>
						<td colspan="3" class="availableDates">
							<div class="inputWrap">
								<strong>1 순위</strong>
								<div class="calInput">
...
%>
					...
					<tr class="cate 003">
						<th scope="row"><label for="type">참석 예상인원</label></th>
						<td colspan="3">
...
%>
					...
					<tr class="cate 004">
						<th scope="row"><label for="type">객실 사용여부</label></th>
						<td colspan="3">
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="title" id="title" style="width:660px" maxlength="20"></td>
					</tr>
					<tr>
						<th scope="row"><label for="cont" id="question_txt">내용</label></th>
						<td colspan="3"><textarea id="question" name="question" style="width:660px;height:250px;" placeholder="문의주신 내용은 순차적으로 확인 후 연락을 드리고 있습니다. 시간이 소요되는 점 양해 부탁드립니다.
웨딩 관련하여 상담을 원하시는 고객님께서는 카카오톡 채널 &lt;상하농원 웨딩&gt;을 검색하여 채팅 문의 주시면 원활한 상담이 가능합니다."></textarea></td>
					...
					<tr class="cate 004">
						...
						<td colspan="3">
							<p class="fileBox">
								<a href="/files/hotel/파머스빌리지_행사견적요청양식_2018.docx" target="_blank" class="btnTypeA">견적 요청 양식 업로드</a>
								<input type="text" id="fileText" readonly="readonly" style="width:417px;">
								<span class="file btnTypeB">파일첨부<input type="file" id="attach" name="attach" onchange="$('#fileText').val($('#attach').val())"></span>
							</p>
							<span>* 보다 자세한 견적요청을 원하시는 분들은 파일을 다운받아 세부내용을 기재하여 파일을 첨부해 주세요.</span>
							<span>* .doc/.pdf 10MB이하 업로드 가능</span>
						</td>
					</tr>
				</table>
