...
(function () {
	...
	fullScroll.prototype.buildDots = function () {		
		...
		$('#dot0').html('<span class="DotTitle">HOME</span>');
		$('#dot1').html('<span class="DotTitle">ADVANCE<span class="MenuTitle2">BOOKING</span></span>');
		$('#dot2').html('<span class="DotTitle">GAME COVER</span>');
		$('#dot3').html('<span class="DotTitle">CHARACTER</span>');
		$('#dot4').html('<span class="DotTitle">NEWS</span>');
		$('#dot5').html('<span class="DotTitle">NEWS2</span>');
		$('#dot6').html('<span class="DotTitle">DOWNLOAD</span>');
	...
	fullScroll.prototype.addEvents = function () {
		...
		if (document.addEventListener) {
			...
			window.addEventListener("hashchange2", this.hashChange2, false);
