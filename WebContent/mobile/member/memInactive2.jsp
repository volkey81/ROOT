...
<%
        ...
        String reqNum      = "";														//요청번호
        String retUrl      = "23" + request.getScheme() + "://" + request.getServerName() + "/auth/sciIpinPopup.jsp?screenCd=memInactive";//결과 수신 URL       
        String srvNo       = "";	    												//서비스번호
    	...
    	FrontSession fs = FrontSession.getInstance(request, response);
       	...
       	SanghafarmUtils.setCookie(response, "unfyMmbNo", strUnfyMmbNo, fs.getDomain(), 1800);
...
<div id="wrapper" class="login">
	...
	<div class="mmwrap joininner">
		...
		<strong class="lg_resting_St">휴면해제와 안전한 이용을 위한<br />본인인증 절차입니다</strong>
		<p class="lg_resting_P" style="padding-bottom:0;">타인이 계정을 접속하여 사용하는 것을 방지하기 위하여<br />본인인증을 하고 있습니다.</p>
		<p class="lg_resting_P">본인인증 시 제공되는 정보는 해당 인증기관에서 직접수집하며,<br />인증 이외의 용도로 이용되지 않습니다.</p>		
