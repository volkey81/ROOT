...
%>
	...
	<div class="mmwrap joininner">
		<strong class="lg_resting_St">회원가입을 위한 안전한 본인인증 단계</strong>
		<p class="lg_resting_P">본인인증 시 제공되는 정보는 해당 인증기관에서<br />직접수집하며 인증 이외의 용도로 이용되지 않습니다.</p>
		<div class="ageCheck">
			<p class="text">만 14세 미만은 가입하실 수 없습니다.</p>
			<label><input type="checkbox" name="chkage" onclick="setCheck(this)"> 오늘 기준, 본인은 만 14세 이상입니다.</label>
		</div>
		<div class="accreditlist" style="display:none;">
			<ul>
				<li class="accreditshow">
					<span class="btnFirst" href="javascript:void(0);">휴대전화 본인인증</span>
					<div class="accreditBox" style="display:block">
						<form name="input_form" id="input_form" method="post" action="<%= joinUrl%>">
							<input type="hidden" name="dupInfo" id="dupInfo" value="" />
							<input type="hidden" name="connInfo" id="connInfo" value="" />
							<input type="hidden" name="connInfoVer" id="connInfoVer" value="" />
							<input type="hidden" name="certDv" id="certDv" value="1" />
									...
									<div class="join_agreementView">
										...
										<div class="jointoggleTT onArrjoin">
											<div class="chkBox">
												<label class="chk_style1">
													<em class="selected">
														<input type="checkbox" name="chk" id="serviceAgree" value="Y">
													</em>
										...
										<div class="jointoggleTT onArrjoin">
											<div class="chkBox">
												<label class="chk_style1">
													<em class="selected">
														<input type="checkbox" name="chk" id="mobileCorpAgree" value="Y">
													</em>
						...
						<ul class="lg_wrapIpst">
							<li>
								<div class="jiPHcols">
									<div class="lg_wipbox">
										<label class="lgipbox">
											<input type="text" id="name" name="name" placeholder="이름" maxlength="45">
										</label>
									</div>
									<label class="lgipbox">
							...
							<li>
								<div class="jiPHcols">
									<div class="lg_wipbox">
										<label class="lgipbox">	
											<input type="text" id="birth" name = "birth" maxlength="8" placeholder="19880227형식의 8자리 숫자로 입력" onKeyPress="return isNumberPressed(this)">
										</label>
									</div>
							...
							<li>
								<div class="jiPhone">
									...
									<label class="lgipbox">
										<input type="tel" id="hpno" name="hpno" maxlength="11" placeholder="-없이 입력하세요." onKeyPress="return isNumberPressed(this)">
									</label>
							...
							<li id="certi" hidden="hidden">
								<div class="jiPhoneC">
									<div class="lg_wipbox">
										<label class="lgipbox">
											<input type="text" maxlength="6" id="reqPccNum" onKeyPress="return isNumberPressed(this)">
										</label>
									</div>
						...
						<p class="phonInfo">알뜰폰 사업자 확인<a href="javascript:;"><img src="/mobile/images/member/ico_checkup.png" alt="" /></a></p>
					</div>
				</li>
				<!-- <li><a class="btnFirst" href="javascript:void(0);" onclick="ipinClick();">아이핀 인증</a></li> -->
			</ul>
		</div>
	</div>
	<!-- //내용영역 -->
