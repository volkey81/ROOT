...
<%
        ...
        String reqNum      = "";														//요청번호
        String retUrl      = "23" + request.getScheme() + "://" + request.getServerName() + "/auth/sciIpinPopup.jsp?screenCd=adultAuth";
        String srvNo       = "";											   		    //서비스번호	
...
<body class="popup adultCertification">
	<div id="popWrap">
		<div id="popCont" class="login">
			...
			<div class="logInTop lgPop">
				<strong>19세 이상 본인인증</strong>
			</div>
			<div class="mmwrap joininner">
				<strong class="lg_resting_St">주류 상품 구매를 위한 19세 이상 본인인증 단계</strong>
								...
								<ul class="lg_wrapIpst">
									...
									<li>
										<div class="jiPHcols">
											<div class="lg_wipbox">
												<label class="lgipbox">	
													<input type="text" id="birth" name = "birth" maxlength="8" placeholder="생년월일" onKeyPress="return isNumberPressed(this)">
												</label>
											</div>
				...
				<div class="btnArea" style="margin-top:40px;">
					<a href="javascript:hidePopupLayer();" class="btnTypeA" style="width:30%;">취소</a>
				</div>
			</div>
			<!-- //내용영역 -->
			</div><!-- //container -->
