...
<%
    ...
    String reqNum      = "";														//요청번호
    String retUrl      = "23" + request.getScheme() + "://" + request.getServerName() + "/auth/sciIpinPopup.jsp?screenCd=findId";//결과 수신 URL
    String srvNo       = "";													//서비스번호
    ...
    String findIdUrl = request.getScheme() + "://" + request.getServerName() + "/mobile/member/findId2.jsp?type=" + param.get("type");//아이디 찾기URL
...
%>
	...
	<div class="mmwrap joininner">
		<strong class="lg_resting_St">아이디 찾기를 위한 안전한 본인인증 단계</strong>
...
<jsp:include page="/mobile/include/pop_footer.jsp" /> 
    ...
    <form name="reqFindid" id="reqFindid" method="post" action="<%=findIdUrl%>">
