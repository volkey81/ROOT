...
function goPrev() {
	$("#orderForm").attr("action", "room.jsp");
	$("#orderForm").submit();
}
	...
	<!-- 내용영역 -->
		<div class="reservation">
			...
			<div class="reservationCont">
				<form name="orderForm" id="orderForm" action="<%= Env.getSSLPath() %>/mobile/hotel/room/reservation/payment.jsp" method="post">
				...
				<div class="infoCont">
					<div class="cont">
						...
						<table class="listStyleB">
							...
							<tbody><tr>
								<th scope="col">이름 *</th>
								<td><input type="text" name="name" id="name" style="width:100%;" maxlength="10"></td>
							</tr>
							<tr>
								<th scope="col">연락처 *</th>
								<td>
									<select name="mobile1" id="mobile1" title="주문자 휴대전화 앞자리" style="width:30%">
<%
...
%>
									...
									<span>-</span>
									<input type="text" name="mobile2" id="mobile2" value="" title="주문자 휴대전화 가운데자리" style="width:29%;">
									<span>-</span>
									<input type="text" name="mobile3" id="mobile3" value="" title="주문자 휴대전화 뒷자리" style="width:29%;">
								</td>
							</tr>
						</tbody></table>
						<ul class="caption">
			...
			<!-- //reservationCont -->		
			<div class="btnArea">
				<a href="javascript:goPrev()" class="btnStyle04">이전</a><a href="javascript:goNext()" class="btnStyle03">다음</a>
			</div>
		</div>
