...
<%-- <%
	if (StringUtils.equals("true", row.get("isSoldOut"))) {
%>
			<p class="btn"><a href="#" onclick="showPopupLayer('/mobile/popup/restock.jsp?pid=<%= row.get("pid") %>'); return false"><img src="/mobile/images/btn/btn_noti.png" alt="재입고 알림"></a></p>
<%
	} else {
...
<script>
setListHeight(".recommendPdt .pdtList", 3); //제품리스트 행간 높이 통일
</script>