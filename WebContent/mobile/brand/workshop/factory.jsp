...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		...
		<div class="workshopArea">
			<img src="/mobile/images/brand/workshop/workshop0601.jpg" alt="">
			<p class="brantTopTxt">상하공장<span>우유와 치즈가 만들어지는 과정을 직접 견학 해보세요!</span></p>
			<img src="/mobile/images/brand/workshop/workshop0602.jpg" alt="">
			<div class="scheduleArea">
				<div class="txtArea">
					<p>
						<img src="/mobile/images/brand/workshop/workshop0603.png" alt="">
				...
				<div class="schedule">
					...
					<!-- <ul class="txt">
					 ...
					 <span>* 공장견학 시간 9:30, 10:30, 14:00, 16:00<br>
					 온라인 예약 우선, 잔여좌석에 한해 매표소 앞 선착순 현장 접수 가능합니다. 견학 시, 매표소에서 발권한 티켓을 반드시 소지하셔야 합니다.<br>
						* 공장이동 안내 : 10:30 / 14:00 (셔틀버스운행) 09:30 / 16:00 (자차이동)<br>
						10분전까지 탑승장 대기 - (공용 주차장 화장실 앞)<br>
						* 일요일 모든 견학은 자차이동 입니다.(10분전까지 공장주차장 도착)<br>
						* 주말에는 공장견학이 동영상으로 대체운영 됩니다.</span>
					<!-- <p class="btn"><a href="/mobile/brand/play/reservation/admission.jsp" class="icoGo">견학 예약하러가기</a></p> -->
				</div>
			</div>
		</div>
