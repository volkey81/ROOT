...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		...
		<div class="reserForm">
			...
			<h2 class="typeA"><strong class="num">02</strong> 예약 상품</h2>
			<table class="bbsList">
...
<%
	for(Param row : list) {
%>
								<li><strong><%= row.get("qty") %></strong>개</li>
<%
	}
%>
							</ul>
			...
			<!-- //step2 예약상품 -->
			<h2 class="typeA"><strong class="num">03</strong> 총 결제 금액</h2>
			...
			<div class="btnArea ac">
		 		<span><a href="/mobile/brand/index.jsp" class="btnTypeB sizeL">홈 이동</a></span>
		 		<span><a href="/mobile/mypage/reservation/list.jsp" class="btnTypeA sizeL">예약 내역 조회</a></span>
		 	</div>
		</div><!-- //reserForm -->
	<!-- //내용영역 -->
	</div><!-- //container -->
