...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		...
		<p class="reserSrmy">20인 이상의 단체 방문자는 추가적인 할인혜택이 적용됩니다. 방문 계획을 남겨주시면, 전화를 통해 예약을 확정합니다.</p>
	...
	%>
		...
		<form name="reserveForm" id="reserveForm" method="post" action="/brand/play/reservation/reserveProc.jsp">
			<input type="hidden" name="reserve_date" id="reserve_date" />
		<h2 class="typeA"><strong class="num">02</strong> 예약자 정보</h2>
		<div class="groupOption">
			<p>농원 내 식당을 이용할 계획이면 체크해주세요.</p>
		...
		<table class="bbsForm">
			...
			<tr>
				<th scope="row">단체명</th>
				<td><input type="text" name="group_nm" id="group_nm" title="단체명" style="width:100%"></td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row">연락처</th>
				<td>
					<select name="mobile1" id="mobile1" title="연락처 첫자리" style="width:60px">
<%
...
%>
		...
		<h2 class="typeA"><span class="num">03</span> 이용 동의</h2>
		<div class="agreeChk">
			<div class="section">
	 			<h3><a href="#agreeCont1" onclick="showTab3(this, '.icoMore', '.agreeChk .cont'); return false" class="icoMore typeB on">취소/환불 규정에 대한 동의</a> <input type="checkbox" name="agree1" id="agree1"></h3>
	 			<div class="cont">
	 				<div class="scr">
	 		...
	 		<div class="section">
	 			<h3><a href="#agreeCont2" onclick="showTab3(this, '.icoMore', '.agreeChk .cont'); return false;" class="icoMore typeB">예약내역 동의</a> <input type="checkbox" name="agree2" id="agree2"></h3>
	 	...
	 	<div class="btnArea ac">
	 		<a href="javascript:proc()" class="btnTypeA sizeL">상담 등록</a>
	 	</div>
	 	</form>
	<!-- //내용영역 -->
	</div><!-- //container -->
