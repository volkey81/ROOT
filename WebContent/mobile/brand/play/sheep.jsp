...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		...
		<div class="playArea sheep">
			<p class="brantTopTxt">흰 털이 복스러운<br> 양들의 양떼목장 <span>상하농원 대표 운동선수 양들의 보금자리</span></p>
			<div class="txtArea">
				<img src="/mobile/images/brand/play/sheep02.jpg" alt="">
				<p>지금은 30마리의 양떼가 옹기종기 살고 있는데요,<br>상하농원에 가장 최근에 이사온 식구들입니다.<br>점점 식구를 늘려갈 저희 동물 가족들을 <br>환영해 주실거죠?</p>	
			</div>
			<!-- <div class="playSlide">
