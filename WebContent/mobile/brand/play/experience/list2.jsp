...
$(function (){
    ...
    var calSwiper = new Swiper($("#calendarPop .calWrap"), {
		slidesPerView:1,
		spaceBetween:0,
		prevButton: $(".calWrap .prev"),
		nextButton: $(".calWrap .next"),
	}); 
...
<%
	...
	SimpleDateFormat format = new SimpleDateFormat("yyyy '<strong>'EEE' 'MMM dd'</strong>'", Locale.US);
%>	
	<div id="calendarPop">
		<div class="leftArea">
		...
		<div class="calWrap swiper-container">
				<div class="slideCont swiper-wrapper">
<%
	for(int j = 0; j < 3; j++) {
		cal.set(Calendar.DATE, 1);
%>
						<div class="sec swiper-slide">
