...
<div id="popWrap">
	...
	<div id="popCont">
	<!-- 내용영역 -->
		<form name="qnaForm" id="qnaForm" action="qnaProc.jsp" method="post">
...
%>
			...
			<tr>
				...
				<td><input type="text" name="title" id="title" title="질문제목" style="width:420px"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea name="question" id="question" style="width:420px;height:80px" title="질문내용"></textarea></td>
			</tr>
		</table>
		<div class="btnArea">
			<a href="#none" onclick="hidePopupLayer(); return false" class="btnTypeA sizeL">취소</a>
			<a href="#none" onclick="goSubmit(); return false" class="btnTypeB sizeL">등록</a>
		</div>
		</form>
	<!-- //내용영역 -->
	</div><!-- //popCont -->
