...
%>
					<tr>
						<th>
							...
							<label for="crd_id_<%= row.get("crd_id") %>"><img src="https://www.maeildo.com/imageserver<%= SystemChecker.isReal() ? "" : "/stage" %>/<%= row.get("crd_img") %>" alt="카드 이미지" width="90"  class="vm"></label>
						</th>
						<td class="al">
...
%>
		...
		<div class="btnArea">
			...
			<a href="#none" onclick="apply()" class="btnTypeB sizeL">적용</a>
		</div>
	<!-- //내용영역 -->
	</div><!-- //popCont -->
</div><!-- //popWrap -->
