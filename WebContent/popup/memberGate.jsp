...
%>
		parent.location.href = "/order/payment.jsp";
<%
	}
%>
	}
...
<div id="popWrap">
	...
	<!-- 내용영역 -->
		...
		<div class="btnArea">
			<a href="#none" onclick="goOrder();" class="btnTypeA sizeL">비회원 주문</a>
			<a href="#none" onclick="goLogin();" class="btnTypeB sizeL">로그인 후 회원주문</a>
		</div>
		<div class="goLogin">
