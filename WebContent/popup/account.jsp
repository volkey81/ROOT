	...
	<!-- 내용영역 -->
		...
		<table class="bbsForm typeB">
			...
			<tr>
				...
				<td><input type="text" name="lgd_rfaccountnum" id="lgd_rfaccountnum" style="width:320px" title="계죄번호"></td>
			</tr>
			<tr>
				<th scope="row">예금주</th>
				<td>
					<input type="text" name="lgd_rfcustomername" id="lgd_rfcustomername" style="width:320px" title="예금주">
		...
		<div class="btnArea">
			<a href="javascript:hidePopupLayer()" class="btnTypeA sizeL">취소</a>
			<a href="javascript:cancelOrder()" class="btnTypeB sizeL">등록</a>
		</div>
	<!-- //내용영역 -->
	</div><!-- //popCont -->
</div><!-- //popWrap -->
