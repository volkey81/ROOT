...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		<div class="playArea2">
			<div class="playHead bg03">
				<p>행복한 소들의 보금자리, 상하농원 젖소목장
					<span>유기농 초지, 2급수 이상의 마실 물. 행복한 소들이 함께하는 공간</span>
				</p>
			</div>
			<div class="playType bg03">
				<p>사람과 자연,<br>동물이 함께 살아갈 수 있다는 것을<span>상하농원 젖소 목장에서 살고 있는<br>행복한 젖소를 통해, 직접 눈으로 확인하세요!</span></p>
			</div>
			<div class="playTime">
