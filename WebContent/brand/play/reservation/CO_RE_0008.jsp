        ...
        <div class="body_wrap">
            ...
            <div class="top_wrap w1080 f_g">
                ...
                <p class="navi_wrap fr">
                    ...
                    <span>비회원 주문/예약 내역 조회</span>
                </p>
            </div>
            <div class="content_wrap mt40">
                <p class="pageTitle">비회원 주문/예약 내역 조회</p>
                ...
                <ul class="ulTable mt20">
                    <li>
                        <div class="ulTable_line">
                            <span class="line_title">수취인</span>
                            홍길동
                        </div>
                        <div class="ulTable_line">
                            <span class="line_title">휴대전화</span>
                    ...
                    <li>
                        <div class="ulTable_line">
                            <span class="line_title">배송지</span>
                            03142) 서울트별시 종로구 종로1길 50 더케이트윈타워 A동
                        </div>
                    </li>
                    <li>
                        <div class="ulTable_line">
                            <span class="line_title">배송 요청사항</span>
                            -
                        </div>
                    </li>
                    <li>
                        <div class="ulTable_line">
                            <span class="line_title">품절옵션</span>
                            품절 시 따로 배송
                        </div>
                    </li>
                </ul>

                <div class="ulTitle mt40">주문상품</div>
                <ul class="ulTable type_product">
                    <li>
                        <div class="ulTable_line">
                            <p class="product_img"><a><img src="./image/img_product.png" alt=""></a></p>
                            <div class="product_info">
                                <p class="product_title">
                                    <a href="">상하농원 우리쌀 식혜 500ml</a>
                                </p>
                                <p class="product_subtitle">
                                    <a href="">상하농원 우리쌀 식혜 500ml</a>
                                </p>
                                <button type="button" class="btn_text">상품평쓰기</button>
                            </div>
                ...
                <div class="ulTitle mt40">결제금액</div>
