...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		...
		<div class="ac"><p class="reserSrmy">입장권을 온라인으로 구매하시면, 현장에서의 발권에 소요되는 시간을 줄일 수 있습니다.</p></div>
		...
		<div class="reserForm">
			<div class="fl">
				...
				<table class="bbsForm">
					...
					<tr>
						<th scope="row">성명</th>
						<td><input type="text" name="name" id="name" value="<%= fs.getUserNm() %>" title="성명" style="width:152px"></td>
					</tr>
					<tr>
...
%>
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="email2" id="email2" value="<%= fs.getEmail2() %>" title="이메일 뒷자리" style="width:140px">
...
%>
				...
				<div class="reserHead">
					...
					체험권 구매를 원하시나요? <a href="experience.jsp" class="btnTypeA sizeS icoGo">체험권 구매</a>
				</div>
				<table class="bbsList">
					<caption>입장권 수량 선택</caption>
					<colgroup>
						<col width=""><col width="90"><col width="140"><col width="90">
					</colgroup>
					<thead>
						<tr>
							<th scope="col">입장권</th>
					...
					<tbody>
						<tr>
							<th scope="row" class="fontTypeB">대인 입장권  <span class="fontTypeD">(18세 이상~)</span> <strike>8,000원</strike></th>
							<td class="ar price"><span><%= Utils.formatMoney(Config.get("admission.fee.001")) %></span>원</td>
							<td>
								<p class="countNum">
									<a href="javascript:setQty('dn', '001')"><img src="/images/btn/btn_minus2.png" alt="-"></a>
									<input type="text" name="qty_001" id="qty_001" value="0" readonly>
									<a href="javascript:setQty('up', '001')"><img src="/images/btn/btn_plus2.png" alt="+"></a>
						...
						<tr>
							<th scope="row" class="fontTypeB">소인 입장권  <span class="fontTypeD">(만 4세~만 18세)</span> <strike>5,000원</strike></th>
							<td class="ar price"><span><%= Utils.formatMoney(Config.get("admission.fee.002")) %></span>원</td>
							<td>
								<p class="countNum">
									<a href="javascript:setQty('dn', '002')"><img src="/images/btn/btn_minus2.png" alt="-"></a>
									<input type="text" name="qty_002" id="qty_002" value="0" readonly>
									<a href="javascript:setQty('up', '002')"><img src="/images/btn/btn_plus2.png" alt="+"></a>
						...
						<!-- 
						<tr>
							<th scope="row" class="fontTypeB">4인 입장권  <span class="fontTypeD">(대인소인 구분없이 4인까지)</span></th>
							<td class="ar price"><span><%= Utils.formatMoney(Config.get("admission.fee.003")) %></span>원</td>
							<td>
								<p class="countNum">
									<a href="javascript:setQty('dn', '003')"><img src="/images/btn/btn_minus2.png" alt="-"></a>
									<input type="text" name="qty_003" id="qty_003" value="0" readonly>
									<a href="javascript:setQty('up', '003')"><img src="/images/btn/btn_plus2.png" alt="+"></a>
				...
				<ul class="caution">
					...
					<li>우대 및 유아의 경우 관련 증빙 확인 후 입장 시 현장에서 할인 적용됩니다.<br>(자세한 우대사항은 <a href="/brand/introduce/guide.jsp">농원 이용 안내</a>를 통해 확인바랍니다.)</li>
...
%>
						...
						<dd>
							...
							<p class="price"><span class="fontTypeE" id="point_amt_txt">-0</span>P</p>
...
%>
					 		<p><input type="radio" name="pay_type" id="pay_<%= row.get("code2") %>" value="<%= row.get("code2") %>" <%= payType.equals(row.get("code2")) ? "checked" : "" %>>
					 		<label for="pay_<%= row.get("code2") %>" style="color:<%= "006".equals(row.get("code2")) ? "red" : "" %>"><%= row.get("name2") %></label></p>
<%
	}
%>
					 	</div>
...
<!-- <div class="popWait">
	<p class="close"><a href="#" onclick="hidePopup(this); return false"><img src="/images/btn/btn_close4.png" alt="닫기"></a></p>
	<div class="text">
		<strong>잠깐만요!</strong><br>상하가족에 가입하시면<br>무료입장권10매 체험 10% 할인권을 <br>증정해드려요!
	</div>
	<div class="btnArea">
		<a href="/familyJoin/" class="typeA">상하가족<br>가입하고 할인받기<span class="ico">GO</span></a>
		<a href="#" onclick="hidePopup(this); return false" class="typeB">할인없이<br>입장/체험권 예약하기<span class="ico">GO</span></a>
	</div>
</div>
<script>
$(window).on("load", function(){
	$(".popWait").css("top", ($(window).scrollTop()+$(window).height()/2)+"px");
