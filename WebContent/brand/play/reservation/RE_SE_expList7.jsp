...
%>
 <div class="people_wrap">
   ...
   <input type="number" 
                    		id="qty_<%= row.get("exp_pid") %>_<%= row.get("ticket_type") %>"
                    		class="input_g input_people" 
                    		name="qty_<%= row.get("exp_pid") %>_<%= row.get("ticket_type") %>"
                    		value=0 >
...
<li class="program_type1">
        ...
        <p class="program_title"><%= row.get("exp_type_nm") %></p>
