...
<%
	...
	if(isMobileOS) {
		Utils.sendMessage(out, "모바일용 화면으로 이동합니다.", "/mobile/brand/play/reservation/experience.jsp");
		return;
	}
	// End of Device check
...
// 		console.log("reservedNum : " + reservedNum);
...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		...
		<div class="ac"><p class="reserSrmy">상하농원 먹거리 체험 프로그램을 사전에 예약하고, 이용할 수 있습니다.</p></div>
...
%>
				...
				<div class="reserHead">
					...
					입장권만 구매하길 원하시나요? <a href="admission.jsp" class="btnTypeA sizeS icoGo">입장권 구매</a>
				</div>
				<div class="program">
