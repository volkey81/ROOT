...
<%
	...
	request.setAttribute("MENU_TITLE", new String("핵심가치"));
%>
<!DOCTYPE HTML>
<html lang="ko">
<head>
...
<div id="snbBrand">
	...
	<ul class="menu01">
		...
		<li class="on"><a href="/brand/bbs/jobnotice/story1.jsp">핵심가치</a></li>
	...
	<div class="contBody">
		<table width="1000" align="center" cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					<td>
						<img style="width:100%;" src="/images/brand/bbs/story1.png" alt="핵심가치"  border="0" usemap="#imageMap1">						
						<map name="imageMap1">
