		...
		<div id="contArea">
			...
			<form name="noticeForm" id="noticeForm">
				<fieldset>
					...
					<select name="keytype" id="keytype" title="유형선택" style="width:145px">
						<option value="">전체</option>
						<option value="01" <%= param.get("keytype").equals("01") ? "selected" : "" %>>제목</option>
					</select>
					<input type="text" name="keyword" id="keyword" title="검색어" style="width:290px" value="<%= Utils.safeHTML2(param.get("keyword")) %>">
					<a href="javascript:void(0)" onclick="$('#noticeForm').submit()" class="btnTypeA sizeL">검색</a>
				</fieldset>
				</form>
			</div>
			<table class="bbsList typeD">
				...
				<colgroup>
					<col width="90"><col width=""><col width="130">
				</colgroup>
				<thead>
					<tr>
						<th scope="col">번호</th>
