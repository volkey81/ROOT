...
<div id="wrapper">
	...
	<!-- 내용영역 -->
		<div class="bbsView">
			...
			<div class="foot">
				<ul class="sns">
					<li class="facebook"><a href="#" onclick="sendSns('facebook');return false;">페이스북 공유하기</a></li>
					<li class="twitter"><a href="#" onclick="sendSns('twitter');return false;">트위터 공유하기</a></li>
					<li class="kakao"><a href="#" onclick="shareStory();return false;">카카오톡 공유하기</a></li>
				</ul>
