...
<div id="wrapper">
	...
	<div id="container" class="guideWrap">
	<!-- 내용영역 -->
		<h2>운영시간</h2>
		<table class="list">
			<colgroup>
		...
		<div class="useWarning">
			...
			<ul class="caution">
				...
				<li>사전 협의가 없는 농원 내 무단 촬영을 금지합니다. <span class="colorB">※ 위반 시 즉시 퇴장조치 될 수 있습니다.</span><br>
					<p class="colorA">1) 방송/잡지사 촬영&nbsp;&nbsp;&nbsp;&nbsp;2) 웨딩 촬영&nbsp;&nbsp;&nbsp;&nbsp;3) 쇼핑몰 촬영&nbsp;&nbsp;&nbsp;&nbsp;4) 개인 인터넷 방송 촬영<br>
		...
		<ul class="caution bg2">
			...
			<li>2022년 9월 1일 부로 패키지권 판매가 종료됩니다.</li>
		</ul>
	<!-- //내용영역 -->
	</div><!-- //container -->
