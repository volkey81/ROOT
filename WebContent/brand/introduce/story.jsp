...
<div id="wrapper">
	...
	<div class="contBody">
		<h2>
			<span>농원에서 온 편지</span>
			햇살 내려앉은 상하농원에서 대표농부 드림
		</h2>
		
		<img src="/images/brand/introduce/story/visual.jpg" alt="안녕하세요 상하농원입니다.">
		<p class="handTxt"><img src="/images/brand/introduce/story/txt.gif" alt="도시에 살고있는 우리에게 거리마다 가득찬 식다으이 화려한 음식과 슈퍼마켓에 진열되어 잇는 수많은 인스턴트 식품은 어머니가 해주신 한 그릇의 따뜻한 된장찌개 보다 익숙합니다. 넘쳐나는 먹거리 속에 담긴 우리의 불안은 이 잃어 버린 멀건 된장찌개에서 비롯된 것은 아닐까요? 쌀이 슈퍼마켓에서 나온다는 우리 아이들에게 먹거리에 대한 소중함과 어머니의 맛을 알려주기 위해 저희는 상하를 찾았고, 마을을 꾸렸습니다. 사계절, 이십사절기 풍요로운 자연에 순응하고 안심할 수 있는 건강한 먹거리를 생산하며 된장찌개 한 그릇의 소박한 즐거움을 누리며 살아가는 상하온원 젊은 농부 한사람, 한사람의 마음을 그대로 담아 여러분들께 전달하는 그 날까지."></p>
		
		<div class="keywordArea">
			<div class="section">
				<strong><img src="/images/brand/introduce/story/tit_keyword1.png" alt="짓다"></strong>
			...
			<div class="section">
				<strong><img src="/images/brand/introduce/story/tit_keyword2.png" alt="놀다"></strong>
			...
			<div class="section">
				<strong><img src="/images/brand/introduce/story/tit_keyword3.png" alt="먹다"></strong>
