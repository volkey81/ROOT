...
%>
						<div class="modify" style="display:none" id="contents1_<%= row.get("sub_seq") %>">
							...
							<a href="javascript:goModify('<%= row.get("sub_seq") %>')" class="btn"><img src="images/btn_ok.png" alt="확인"></a>
						</div>
...
<%
	if(totalCount > 0) {
		FrontPaging paging = new FrontPaging("javascript:getComment([page])", totalCount, nPage, PAGE_SIZE, BLOCK_SIZE);
