...
function getCalendar(year, month) {
	...
	.done(function(html) {
		...
		//efuSlider('.calendarWrap', 1, 0, '', 'once');
		...
		parent.$(".popReserLayer .layer").height($(document).height());
		$(".offerReserLayer").height($(document).height() - 100)
...
function reset(){
	...
	$('#avail_qty').val(0);
	$('#default_price').val(0);
	$('#default_adult_price').val(0);
	$('#default_child_price').val(0);
...
<body>
	<div class="offerReserLayer">
		...
		<div class="choiceSrmy">
			...
			<p class="price">
				총 예상금액 <span class="original">0원</span> <strong id="totPrice">0</strong>원 <span class="sub">(VAT포함)</span>
			</p>
