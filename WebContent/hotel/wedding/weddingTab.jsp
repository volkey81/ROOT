...
<div class="subTab animated fadeInUp delay02">
	<ul>
		<li<%if(Depth_1 == 5 && Depth_2 == 4 && Depth_3 == 1){ %> class="on"<%} %>><a href="/hotel/wedding/wedding.jsp">웨딩&amp;연회</a></li>
		<li<%if(Depth_1 == 5 && Depth_2 == 4 && Depth_3 == 2){ %> class="on"<%} %>><a href="/hotel/wedding/seminar.jsp">세미나</a></li>
	</ul>
</div>
