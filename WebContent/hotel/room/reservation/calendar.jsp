...
%>
						<a href="javascript:getCalendar(<%= c.get(Calendar.YEAR) %>, <%= c.get(Calendar.MONTH) + 1 %>)"><img src="/images/btn/btn_prev.png" alt="이전달" class="prev"></a>
<%
	}
	...
	if(ym.compareTo(Utils.getTimeStampString(cal2.getTime(), "yyyyMM")) < 0) {
		...
		c.add(Calendar.MONTH, 1);
%>
						<a href="javascript:getCalendar(<%= c.get(Calendar.YEAR) %>, <%= c.get(Calendar.MONTH) + 1 %>)"><img src="/images/btn/btn_next.png" alt="다음달" class="next"></a>
<%
	}
%>