	...
	<div id="container" class="hotel room">
		...
		<div class="reservation">
			...
			<div class="reservationCont">
				<form name="orderForm" id="orderForm" action="<%= Env.getSSLPath() %>/hotel/room/reservation/payment.jsp" method="post">
...
<%
		...
		if(roomCnt > 0) {
			...
			listTxt += "<ul><li class=\"first\">" + row.get("room_knd_nm") + "<span>" + roomCnt + " 객실</span></li>" + txt + "</ul>";
		}
	}
%>
				<!-- infoCont -->
