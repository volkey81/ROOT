...
<div id="wrapper">
	...
	<div id="container" class="hotel enjoy">
		<!-- 내용영역 -->		
		<jsp:include page="/hotel/enjoy/enjoyTab.jsp" />
		<!-- diningSlide -->
		<div class="poolHead animated fadeInUp delay04">
			<p class="ac"><img src="/images/hotel/enjoy/visual_pool.jpg" alt=""></p>
			
			<div class="topTxt">
				<span class="sTxt">SANGHAFARM</span>
				<p class="contTit">INTRODUCTION</p>
			</div>
			<p class="text">자연 속에서 품격 있는 휴식을 즐길 수 있는 파머스빌리지 수영장에서 재충전의 시간을 가져보세요.<br>모자이크 타일 공법으로 더욱 견고하고, 은은하게 빛이 나는 풀장으로, 달팽이 모형의 독특한 유아풀에서 미끄럼틀과 적절한 온도의 온수풀로 운영하고 있어 가족들과 안전한 물놀이를 즐길 수 있으며,  50X24m의 넓은 규격의 대형 풀에서 선선히 불어오는 서해 바닷 바람을 느끼며 자연이 주는 이국적인 정취를 느껴보세요. </p>
			...
			<div class="info">
				...
				<div class="fl">
					<p>PERIOD</p>
					정식 오픈&nbsp;&nbsp;23.06.24 ~ 23.09.03
				</div>
				<div class="fr">
					<p>HOURS OF OPERATION</p>
					정식 오픈&nbsp;&nbsp;9:30 ~ 18:30 (50분 운영,  10분 휴게)</span><br>
					<span class="sub">수질정비시간에는 입수가 제한될 수 있습니다.</span>
				</div>
			</div>
		</div>
		<!-- //diningSlide -->
		
		<div class="experienceCont poolCont">
			<div class="slideArea">
				<div class="weddingSlide">
					<img src="/images/hotel/enjoy/slide_pool1.jpg" alt="">
				</div>
				<div class="weddingSlide">
					<img src="/images/hotel/enjoy/slide_pool2.jpg" alt="">
				</div>
				<div class="weddingSlide">
					<img src="/images/hotel/enjoy/slide_pool3.jpg" alt="">
				</div>
				<div class="weddingSlide">
					<img src="/images/hotel/enjoy/slide_pool4.jpg" alt="">
				</div>
			</div>
			...
			<div class="info">
				...
				<ul class="facility">
					<li>
						<img src="/images/hotel/enjoy/thumb_pool1.jpg" alt="">
						<p>야외 수영장</p>
					...
					<li>
						<img src="/images/hotel/enjoy/thumb_pool2.jpg" alt="">
						<p>파머스 카바나</p>
						선선히 불어오는 서해 바닷 바람을 느끼며<br>프라이빗한 시간을 누리는 독립형 휴식 공간
					</li>
					<li>
						<img src="/images/hotel/enjoy/thumb_pool3.jpg" alt="">
						<p>파머스 스낵바</p>
				...
				<h2>가격정보</h2>
				<table>
					<col width="165"><col width="435"><col width="">
					<thead>
						<tr>
				...
				<table>
					<thead>
						<tr>
							<th scope="col">구분</th>
							<th scope="col">파머스빌리지/글램핑 투숙객</th>
							<th scope="col">고창군민</th>
							<th scope="col">정읍/광주/영광/전주</th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<!-- <div class="btnArea">
					<a href="http://www.sanghafarm.co.kr/hotel/village/location.jsp" class="btnStyle01">오시는길</a>
					<a href="http://www.sanghafarm.co.kr/hotel/village/promotion/list.jsp" class="btnStyle02">관련프로모션 보기</a>
				</div> -->
			</div>
		</div><!-- //poolCont -->
		<!-- //내용영역 -->
