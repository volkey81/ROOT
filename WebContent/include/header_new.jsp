...
<div id="<%=Depth_1 == 1 || Depth_1 == 5 ? "header2" : "header" %>">
	<div class="wrap">
		<div id="headerTop">
			<div class="topCont">
				<ul class="util">
	...
	%>
				...
				<li<%if(Depth_1 == 5){ %> class="on"<%} %>><a href="/hotel/index.jsp"><img src="/images/layout/nav3_1.png" alt="파머스빌리지"></a>
					<div class="mainNav village" id="villageGnb">
						<ul>
							<li><a href="/hotel/room/reservation/date.jsp">예약</a>
								<ul>
									<li><a href="/hotel/room/reservation/date.jsp">객실</a></li>
									<li><a href="/hotel/offer/list.jsp">스페셜오퍼</a></li>
									<li><a href="/brand/play/experience/list.jsp">입장&체험</a></li>
								</ul>
							</li>
							<li<%if(Depth_1 == 5 && Depth_2 == 2){ %> class="on"<%} %>><a href="/hotel/room/index.jsp">객실예약</a>
								<ul>
							...
							<li<%if(Depth_1 == 5 && Depth_2 == 6){ %> class="on"<%} %>><a href="/hotel/offer/list.jsp">스페셜오퍼</a>
								<ul>
							...
							<li<%if(Depth_1 == 5 && Depth_2 == 4){ %> class="on"<%} %>><a href="/hotel/wedding/wedding.jsp">웨딩&amp;세미나</a>
								<ul>
									<li><a href="/hotel/wedding/wedding.jsp">웨딩&amp;연회</a></li>
									<li><a href="/hotel/wedding/seminar.jsp">세미나</a></li>
								</ul>
							</li>
							<li<%if(Depth_1 == 5 && Depth_2 == 5){ %> class="on"<%} %>><a href="/hotel/enjoy/farm.jsp">즐길거리</a>
								<ul>
									<li><a href="/hotel/enjoy/farm.jsp">상하농원</a></li>
									<%--<li><a href="/hotel/enjoy/experience.jsp">시즌체험</a></li>--%>
