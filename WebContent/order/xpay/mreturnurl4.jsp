...
// 	String LGD_PAYKEY	= request.getParameter("LGD_PAYKEY");
	String LGD_RESPCODE = param.get("LGD_RESPCODE");
	String LGD_RESPMSG 	= param.get("LGD_RESPMSG");
	String LGD_PAYKEY	= param.get("LGD_PAYKEY");
	
	System.out.println("@@@@@@@@@@@@@ mreturnurl4.jsp - LGD_RESPCODE : " + LGD_RESPCODE);
	System.out.println("@@@@@@@@@@@@@ mreturnurl4.jsp - LGD_RESPMSG : " + LGD_RESPMSG);

	try {
		String ua=request.getHeader("User-Agent");
		System.out.println("@@@@@@@@@@@@@ mreturnurl4.jsp - UserAgent : " + ua);
	} catch(Exception e) {}
%>
<html>
<head>
...
<% 
	if("0000".equals(LGD_RESPCODE)){
%>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="<%= Env.getSSLPath() %>/customer/payment/orderProc.jsp">
<%= info.get("form") %>
</form>
<%
	}
