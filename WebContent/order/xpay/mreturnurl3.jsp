...
// 	String LGD_PAYKEY	= request.getParameter("LGD_PAYKEY");
	...
	System.out.println("@@@@@@@@@@@@@ mreturnurl3.jsp - LGD_RESPCODE : " + LGD_RESPCODE);
	System.out.println("@@@@@@@@@@@@@ mreturnurl3.jsp - LGD_RESPMSG : " + LGD_RESPMSG);

	try {
		String ua=request.getHeader("User-Agent");
		System.out.println("@@@@@@@@@@@@@ mreturnurl3.jsp - UserAgent : " + ua);
	} catch(Exception e) {}
%>
<html>
<head>
...
<% 
	if("0000".equals(LGD_RESPCODE)){
%>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="<%= Env.getSSLPath() %>/familyJoin2018/orderProc.jsp">
<%= info.get("form") %>
</form>
<%
	}
