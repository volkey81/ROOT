...
<%
	...
	System.out.println("@@@@@@@@@@@@@ mreturnurl2.jsp - LGD_RESPCODE : " + LGD_RESPCODE);
	System.out.println("@@@@@@@@@@@@@ mreturnurl2.jsp - LGD_RESPMSG : " + LGD_RESPMSG);

	try {
		String ua=request.getHeader("User-Agent");
		System.out.println("@@@@@@@@@@@@@ mreturnurl2.jsp - UserAgent : " + ua);
	} catch(Exception e) {}
%>
<html>
<head>
...
<% 
	if("0000".equals(LGD_RESPCODE)){
%>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="<%= Env.getSSLPath() %>/brand/play/reservation/orderProc2.jsp">
<%= info.get("form") %>
</form>
<%
	}
