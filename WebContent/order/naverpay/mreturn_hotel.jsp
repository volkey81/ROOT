...
<form method="post" name="orderSessionForm" id="orderSessionForm" action="<%= Env.getSSLPath() %>/hotel/room/reservation/proc.jsp">
	<%= info.get("form") %>
</form>
<%
	} else {
		...
		Utils.sendMessage(out, msg, "/mobile/hotel/room/reservation/date.jsp");
	}
%>
