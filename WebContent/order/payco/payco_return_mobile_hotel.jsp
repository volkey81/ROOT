...
<body onload="goOrder()">
	<form name="orderForm" id="orderForm" method="POST" action="<%= Env.getSSLPath() %>/hotel/room/reservation/proc.jsp">
		<%= info.get("form") %>
	</form>
</body>
</html>
<%
		...
		Utils.sendMessage(out, message + "(" + code + ")", "/mobile/order/cart.jsp");
		return;
	} 
%>					
