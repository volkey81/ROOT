...
<body onload="goOrder()">
	<form name="orderForm" id="orderForm" method="POST" action="<%= Env.getSSLPath() %>/hotel/offer/proc.jsp">
		<%= info.get("form") %>
	</form>
</body>
</html>
<%
		...
		System.out.println("------------------ payco : " + code + ", " + message);
		Utils.sendMessage(out, message + "(" + code + ")");
		return;
	} 
%>					
