...
<div id="wrapper">
	...
	<div id="container">
	<!-- 내용영역 -->
		<!-- <p class="visual"><img src="/images/product/visual_recipe.jpg" alt=""></p> -->
		<div class="search">
			<form id="fmenuForm">
			<fieldset>
				<legend>레시피 검색</legend>
				<select name="keytype" title="유형선택" style="width:145px">
				...
				<input type="text" name="keyword" value="<%= param.get("keyword") %>" title="검색어" style="width:290px"> 
				<a href="#" onclick="$('#fmenuForm').submit()" class="btnTypeB sizeL">검색</a>
			</fieldset>
			</form>
		</div>
		<ul class="recipeList">
